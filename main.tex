...
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Difference Test}]
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Ratio Test}]
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Derivative Test}]
...
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Divergence Test}]
		\begin{equation*}
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={$p$-Series}]
		\begin{description}[style=sameline]
			\item[Form] $\displaystyle \sum_{i=1}^\infty \frac{1}{i^p}$.
		\end{description}
		\begin{equation*}
			\text{Is $p>1$?}\:
			\begin{cases}
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Geometric Series}]
		\begin{description}[style=sameline]
			\item[Form] $\displaystyle \sum_{i=0}^\infty a r^i$ or $\displaystyle \sum_{i=1}^\infty a r^{i-1}$.
		\end{description}
		\begin{equation*}
			\text{Is $\abs{r}<1$?}\:
			\begin{cases}
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Alternating Series}]
		\begin{description}[style=sameline]
			\item[Form] $\displaystyle \sum_{i=i_0}^\infty \left( -1 \right)^i b_i$ or $\displaystyle \sum_{i=i_0}^\infty \left( -1 \right)^{i+1} b_i$.
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Telescoping Series}]
		\begin{description}[style=sameline]
		...
		\begin{equation*}
			...
			\begin{cases}
				...
				\text{NO} & \text{$\sum a_i$ Diverges to $s$}
			\end{cases}
		\end{equation*}
	\end{mdframed}
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Comparison Test}]
		\begin{description}[style=sameline]
			\item[Conditions] Pick $b_i$.
		\end{description}
		If $\displaystyle \sum_{i=i_0}^\infty$ converges
		\begin{equation*}
			...
			\end{cases}
		\end{equation*}
		If $\displaystyle \sum_{i=i_0}^\infty$ diverges
		\begin{equation*}
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Limit Comparison Test}]
		\begin{description}[style=sameline]
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Integral Test}]
		\begin{description}[style=sameline]
			\item[Conditions] Let $a_i=f(i)$, and $f(x)$ is continuous, positive and decreasing on $\left[a,\:\infty\right)$.
		\end{description}
		\begin{equation*}
			\text{Does $\int_a^\infty$ converge?}\:
			\begin{cases}
				\text{YES} & \text{$\sum_i=a^\infty a_i$ Converges} \\
				\text{NO} & \text{$\sum a_i$ Diverges}
			\end{cases}
		\end{equation*}
	\end{mdframed}
...
\end{figure}
\begin{figure}[H]
	\begin{mdframed}[style=exampledefault,frametitle={Root Test}]
		\begin{description}[style=sameline]
...
\subsection{Limits of Functions on $\mathbb{R}$}
