...
\begin{definition}
    ...
    \begin{description}[style=sameline]
        \item[Strictly increasing] if $a_n < a_{n+1}$ for all $n$
        \item[Increasing] if $a_n \leqslant a_{n+1}$ for all $n$
        \item[Strictly decreasing] if $a_n > a_{n+1}$ for all $n$
        \item[Decreasing] if $a_n \geqslant a_{n+1}$ for all $n$
    \end{description}
\end{definition}
%
\begin{definition}[Monotone]
    A sequence is (stricly) monotone if it is
    (strictly) increasing or (strictly) decreasing.
\end{definition}
%
\begin{definition}[Eventually]
    If after removing a finite number of terms from the beginning from a sequence
    it has a certain property, the the original sequence has that property eventually.
\end{definition}
%
...
\end{theorem}
%
\subsubsection{Monotonicity Tests}
\begin{mdframed}[style=exampledefault]
    ...
    A sequence $\{a_n\}^\infty_{n=1}$ for which all $a_n$ are all positive is
    \begin{mdframed}[style=exampledefault]
        \begin{description}[style=sameline]
    ...
    \begin{mdframed}[style=exampledefault]
        \begin{description}[style=sameline]
            \item[Strictly increasing] if $a'(x) > 0$ for all $x\in\R_{\geqslant1}$
            \item[Increasing] if $a'(x) \geqslant 0$ for all $x\in\R_{\geqslant1}$
            \item[Strictly decreasing] if $a'(x) < 0$ for all $x\in\R_{\geqslant1}$
            \item[Decreasing] if $a'(x) \leqslant 0$ for all $x\in\R_{\geqslant1}$
        \end{description}
    \end{mdframed}
    \end{theorem}
\end{mdframed}
